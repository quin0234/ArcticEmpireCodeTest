      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/messages/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Message.chatUser() instead.
            "prototype$__get__chatUser": {
              url: urlBase + "/messages/:id/chatUser",
              method: "GET",
            },
        ...
        */
        R.modelName = "Message";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Message#chatUser
             * @methodOf lbServices.Message
             *
             * @description
             *
             * Fetches belongsTo relation chatUser.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Message id
        ...
        R.chatUser = function() {
          ...
          var action = TargetResource["::get::Message::chatUser"];
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Room#updateAttributes
             * @methodOf lbServices.Room
             *
             * @description
             *
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/chatusers/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.ChatUser#patchOrCreate
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.ChatUser#replaceOrCreate
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/chatusers/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.ChatUser#upsertWithWhere
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/chatusers/upsertWithWhere",
              method: "POST",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.ChatUser#replaceById
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/chatusers/:id/replace",
              method: "POST",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.ChatUser#prototype$patchAttributes
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.ChatUser#prototype$verify
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
             ...
             */
            "prototype$verify": {
              url: urlBase + "/chatusers/:id/verify",
              method: "POST",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.ChatUser#changePassword
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
             ...
             */
            "changePassword": {
              url: urlBase + "/chatusers/change-password",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.ChatUser#setPassword
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
             ...
             */
            "setPassword": {
              url: urlBase + "/chatusers/reset-password",
              method: "POST",
            },
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.ChatUser#patchOrCreateWithWhere
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.ChatUser#updateAttributes
             * @methodOf lbServices.ChatUser
             *
             * @description
             *
